...
export const createHonor = (data: { title: string; description?: string; image?: string; order?: number; is_active?: number }) => {
  return request.post("admin/Honor", data);
};

export const updateHonor = (id: number, data: { title?: string; description?: string; image?: string; order?: number; is_active?: number }) => {
