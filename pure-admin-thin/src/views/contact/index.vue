  ...
  <div class="contact-management">
    ...
    <div v-else class="content-container">
          ...
          <div class="info-content">
            ...
            <div v-if="!contactData" class="empty-state">
              <el-empty description="暂无联系信息">
                <el-button type="primary" size="large" @click="handleEdit">添加信息</el-button>
              </el-empty>
            </div>
      ...
      <div v-else class="edit-mode">
        <div class="info-card">
          <div class="card-header">
            <span class="header-title">{{ contactData ? '编辑联系信息' : '添加联系信息' }}</span>
          </div>
          ...
          <div class="edit-content">
            <el-form ref="formRef" :model="formData" :rules="rules" label-width="120px" label-position="right"
              ...
              <el-form-item label="公司电话" prop="company_phone">
                <el-input v-model="formData.company_phone" placeholder="请输入公司电话" clearable />
              </el-form-item>

              <el-form-item label="服务电话" prop="service_phone">
                <el-input v-model="formData.service_phone" placeholder="请输入服务电话" clearable />
              </el-form-item>
              ...
              <el-form-item label="邮政编码" prop="postal_code">
                <el-input v-model="formData.postal_code" placeholder="请输入邮政编码" clearable />
              </el-form-item>

              <el-form-item label="公司地址" prop="address">
                <el-input v-model="formData.address" type="textarea" :rows="3" placeholder="请输入公司地址" />
              </el-form-item>
            </el-form>
          </div>
...
const fetchContactInfo = async () => {
  ...
  try {
    ...
    if (response && response.data) {
      contactInfoList.value = Array.isArray(response.data) ? response.data : [response.data];
